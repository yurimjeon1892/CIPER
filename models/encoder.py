...
class Encoder(VisionTransformer):
    ...
    def __init__(self, args, img_size, mode="reference", norm_layer=partial(nn.LayerNorm, eps=1e-6)):
        super().__init__(img_size=img_size, patch_size=args["patch_size"], embed_dim=args["dim_embed"], 
                         num_classes=args["dim_feature"], depth=args["num_enc_layers"], 
                         num_heads=args["num_heads"], mlp_ratio=args["mlp_ratio"], qkv_bias=args["qkv_bias"], 
